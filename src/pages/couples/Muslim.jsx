...
// Replace with actual Muslim wedding images
import muslim1 from "../../images/gallery/muslim (1).jpg";
import muslim2 from "../../images/gallery/muslim (2).jpg";
import muslim3 from "../../images/gallery/muslim (3).jpg";
import muslim4 from "../../images/gallery/muslim (4).jpg";
import muslim5 from "../../images/gallery/muslim (5).jpg";
import muslim6 from "../../images/gallery/muslim (6).jpg";

const galleryImages = [muslim1, muslim2, muslim3, muslim4, muslim5, muslim6];
        ...
        <div className="columns-1 sm:columns-2 lg:columns-3 gap-6 space-y-6">
          {galleryImages.map((src, index) => (
            ...
            >
              <LazyLoadImage
                src={src}
                alt={`Muslim Wedding Image ${index + 1}`}
                effect="blur"
