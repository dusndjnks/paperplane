...
// Replace these with actual Monu gallery images
import monu1 from "../../images/gallery/monu (1).jpg";
import monu2 from "../../images/gallery/monu (2).jpg";
import monu3 from "../../images/gallery/monu (3).jpg";
import monu4 from "../../images/gallery/monu (4).jpg";
import monu5 from "../../images/gallery/monu (5).jpg";

const galleryImages = [monu4, monu2, monu1, monu3, monu5];
